...
EXPORT DEF wDexSearchSlowpokeFrame EQU $C6DB
EXPORT DEF wMovementBufferCount EQU $CF21
EXPORT DEF wPrevPartyLevel EQU $CF21
EXPORT DEF wPokeFluteCuredSleep EQU $CF21
EXPORT DEF wTempRestorePPItem EQU $CF21
...
EXPORT DEF wFacingTileID EQU $CF53
EXPORT DEF wCurFruitTree EQU $CF53
EXPORT DEF wSeenTrainerDistance EQU $CF54
EXPORT DEF wCurFruit EQU $CF54
...
EXPORT DEF wCurMoveNum EQU $CFC1
EXPORT DEF wPartyMenuCursor EQU $CFC3
EXPORT DEF wTMHMPocketScrollPosition EQU $CFCC
...
EXPORT DEF wSolvedUnownPuzzle EQU $CFDE
EXPORT DEF wFieldMoveSucceeded EQU $CFDE
EXPORT DEF wItemEffectSucceeded EQU $CFDE
EXPORT DEF wStateFlags EQU $CFDF
EXPORT DEF wBattleResult EQU $CFE3
EXPORT DEF wUsingItemWithSelect EQU $CFE5
EXPORT DEF wUnusedNamesPointer EQU $CFF8
EXPORT DEF wCurItem EQU $CFFC
EXPORT DEF wCurItemQuantity EQU $CFFD
